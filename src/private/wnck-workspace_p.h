...
#ifndef _WNCK_WORKSPACE_P_H
#define _WNCK_WORKSPACE_P_H
...
namespace Wnck
{
	...
	class Workspace_Class : public Glib::Class
	{
		public:
		...
		protected:
			...
			static void name_changed_callback(WnckWorkspace* self);
